...
public class ValueObjectGenerator : IIncrementalGenerator
{
	...
	private static void CreateSource(SourceProductionContext context, ImmutableArray<ValueObjectBase> models, AnalyzerConfigOptionsProvider configOptionsProvider)
	{
		...
		{
			var descriptor = new DiagnosticDescriptor(nameof(ValueObjectGenerator), "Error", $"{nameof(ValueObjectGenerator)} failed to generate due to an error. Please inform CodeChops (www.CodeChops.nl). Error: {e.StackTrace}", "Compilation", DiagnosticSeverity.Error, isEnabledByDefault: true);
