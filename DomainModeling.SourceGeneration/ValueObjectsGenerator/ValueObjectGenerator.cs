...
{GetProperty()}
	...
	public static implicit operator {valueObject.TypeName}({valueObject.Name} obj) => obj.Value;
	public static explicit operator {valueObject.Name}({valueObject.TypeName} value) => new(value);

	public {valueObject.Name}({valueObject.TypeName} value)
	{{	
...
";
    ...
    /// </summary>
	private {valueObject.TypeName} Value 
	{{
		get => this.{backingFieldName};
		init 
		{{ 
{valueObject.GetValidationCode()}
	...
	/// </summary>
	[Obsolete]
	private readonly {valueObject.TypeName} {backingFieldName};";
		}
