...
public abstract class MutableListEntity<TSelf, TElement> : Entity, IReadOnlyList<TElement>
	where TSelf : MutableListEntity<TSelf, TElement>
	where TElement : IDomainObject
{
	...
	public virtual TElement this[int index] 
		=> Validator<TSelf>.ThrowWhenInvalid.GuardInRange(this.List, index, errorCode: null)!;
