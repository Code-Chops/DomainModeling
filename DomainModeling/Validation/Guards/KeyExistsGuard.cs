...
{
	public static string GetMessage(string objectName, TKey key)
		=> KeyExistsNoOutputGuard<TKey>.GetMessage(objectName, key);
...
{
	public static Validator GuardKeyExists<TKey>(this Validator validator, Func<TKey, bool> retriever, TKey key, IErrorCode? errorCode, Exception? innerException = null)
		where TKey : notnull
